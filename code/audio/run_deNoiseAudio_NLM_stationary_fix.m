function run_deNoiseAudio_NLM_stationary_fix

% FUNCTION HANDLE
algorithmHandle = @deNoiseAudio_NLM_stationary_fix;

% NLM CONFIGURATION VALUES (NOMINAL)
config = struct();
config.kSize = 301;
config.searchSize = 2049; %nominal value is 5. Must be odd number.
