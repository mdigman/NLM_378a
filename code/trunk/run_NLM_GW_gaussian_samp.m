function run_NLM_GW_gaussian_samp

% FUNCTION HANDLE
algorithmHandle = @deNoise2D_NLM_GW_gaussian_samp;
...
config.searchPoints = 400; %traditionally uses 21*21 = 441
...
% Custom config values
config.searchPoints = 200; %traditionally uses 21*21 = 441
config.effectiveSearchWindow = 51;
...
% Custom config values
config.searchPoints = 100; %traditionally uses 21*21 = 441
config.effectiveSearchWindow = 51;
